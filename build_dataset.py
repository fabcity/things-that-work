...
VE_TEXT = {
 ...
 "id":{
  ...
  "ve_lead":"Pada 24 Juni 2026, dua gempa — magnitudo 7,2, lalu 7,5 sekitar empat puluh detik kemudian — mengguncang pesisir Karibia dekat Morón, sekitar 160 km di barat Caracas. Ini gempa terkuat di Venezuela sejak 1900. Per 26 Juni, korban terkonfirmasi setidaknya 235 tewas, lebih dari 4.300 luka, dan 157 hilang — dan terus bertambah, dengan tim penyelamat masih mencari di sekitar 250 bangunan yang runtuh atau rusak; kawasan Altamira dan Los Palos Grandes di Caracas termasuk yang paling parah. Angka-angka ini akan usang saat kamu membacanya — untuk hitungan terkini dan pengumuman resmi, gunakan sumber di bawah.",
...
try:
    ...
    _ve["printing"]["map"] = {"url":"https://vzla.ushahidi.io/"}
