...
dataset["venezuela"]["community"] = {"items":[
 ...
 {"name":"Makers Brasil — solidarity group","what":"Brazilian makers coordinating 3D printing and fabrication support for Venezuela. Connect if you have a printer and want to contribute designs, files, or know-how.","what_es":"Makers de Brasil coordinando apoyo de fabricación e impresión 3D para Venezuela. Únete si tienes una impresora y quieres aportar diseños, archivos o conocimiento.","what_id":"Komunitas maker Brasil yang mengoordinasikan dukungan cetak 3D untuk Venezuela. Bergabung jika punya printer dan ingin berkontribusi desain, berkas, atau keahlian.","url":"https://chat.whatsapp.com/Iewg2qG8WZIIqzVzcqJkIS","tag":"WhatsApp"},
]}
