...
VE_TEXT = {
 ...
 "id":{
  ...
  "ve_lead":"Pada 24 Juni 2026, dua gempa — magnitudo 7,2, lalu 7,5 sekitar empat puluh detik kemudian — mengguncang pesisir Karibia dekat Morón, sekitar 160 km di barat Caracas. Ini gempa terkuat di Venezuela sejak 1900. Korban meningkat tajam — kini diperkirakan lebih dari 15.000 tewas, dengan ribuan luka dan sekitar 68.900 hilang — dan tim penyelamat masih mencari di sekitar 250 bangunan yang runtuh atau rusak; kawasan Altamira dan Los Palos Grandes di Caracas termasuk yang paling parah. Angka-angka ini akan usang saat kamu membacanya — untuk hitungan terkini dan pengumuman resmi, gunakan sumber di bawah.",
...
dataset["venezuela"]["community"] = {"items":[
 ...
 {"name":"Ostec3D — MakerWorld","what":"The full open-design library from Ostec3D — the source of the emergency splints, updated on their MakerWorld profile.","what_es":"La biblioteca completa de diseños abiertos de Ostec3D — el origen de las férulas de emergencia, actualizada en su perfil de MakerWorld.","what_id":"Pustaka lengkap desain terbuka Ostec3D — sumber bidai darurat, diperbarui di profil MakerWorld mereka.","author":"Ostec3D","url":"https://makerworld.com/en/@Ostec3D","tag":"MakerWorld"},
]}
...
_THANKS_UI = {
 "en":{"thanks_lead":"Thank you, everyone.","thanks_msg":"The splints are delivered and serving the people who needed them. A new phase of the post-earthquake crisis is emerging — stay tuned for the next steps in the communities below. And don't forget to add your 3D-printed parts to the registry.","thanks_cta":"Add your parts to the registry","thanks_now":"What the community is printing now:","thanks_demand":"Before you print, check the local WhatsApp groups to understand what's actually needed.","thanks_part":"Barb-type oxygen cone connector","thanks_all":"all Ostec3D designs"},
 "es":{"thanks_lead":"¡Gracias a todas y todos!","thanks_msg":"Las férulas ya están entregadas y sirviendo a quienes las necesitan. Comienza una nueva fase de la crisis tras el terremoto — mantente atento a los próximos pasos en las comunidades de abajo. Y no olvides añadir tus piezas impresas en 3D al registro.","thanks_cta":"Añade tus piezas al registro","thanks_now":"Lo que la comunidad está imprimiendo ahora:","thanks_demand":"Antes de imprimir, consulta los grupos de WhatsApp locales para saber qué se necesita de verdad.","thanks_part":"Conector cónico de oxígeno (tipo barb)","thanks_all":"todos los diseños de Ostec3D"},
 "id":{"thanks_lead":"Terima kasih untuk semua.","thanks_msg":"Bidai sudah tersalurkan dan membantu mereka yang membutuhkan. Fase baru krisis pascagempa mulai muncul — nantikan langkah berikutnya di komunitas di bawah. Dan jangan lupa tambahkan komponen cetak 3D-mu ke registri.","thanks_cta":"Tambahkan komponenmu ke registri","thanks_now":"Yang sedang dicetak komunitas sekarang:","thanks_demand":"Sebelum mencetak, cek grup WhatsApp lokal untuk tahu apa yang benar-benar dibutuhkan.","thanks_part":"Konektor kerucut oksigen (tipe barb)","thanks_all":"semua desain Ostec3D"},
}
for _lg in ("en","es","id"):
